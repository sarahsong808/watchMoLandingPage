...
<a class="github-button" href="https://github.com/oslabs-beta/watchmo" data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star oslabs-beta/watchmo on GitHub">Star</a>

            <a href="https://github.com/oslabs-beta/watchmo"><img className="banner" src="/cat.png" /></a>
            ...
            <div className="info">
                ...
                <div>
                    <div className="video1">
                        ...
                        <div>
                            <img src="/demo.gif" className="demoGIF" />
                        </div>
                    </div>
                    <div className="video2">
                        <div>
                            <img src="/dashboard.gif" className="dashboardGIF" />
                        </div>
                    ...
                    <div className="video1">
                        ...
                        <div>
                            <img src="/config.gif" className="demoGIF" />
                        </div>
                    </div>
                    </div>
